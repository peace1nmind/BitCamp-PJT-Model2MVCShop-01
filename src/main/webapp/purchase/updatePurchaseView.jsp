	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="dlvyRequest" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= purchaseVO.getDlvyRequest() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<%	String dlvyDate = purchaseVO.getDlvyDate().split(" ")[0];
				...
				String[] dateArray = dlvyDate.split("-");
				dlvyDate = "";
			...
			%>
			<input type="text" readonly="readonly" name="dlvyDate" value="<%= dlvyDate %>" 
